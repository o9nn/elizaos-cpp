...
std::future<{
  ...
  confidence: number;
}> detectModificationIntent(IAgentRuntime runtime, const std::string& messageText);"
...
}> evaluateModificationSafety(IAgentRuntime runtime, const std::any& modification, const std::string& requestText);"
