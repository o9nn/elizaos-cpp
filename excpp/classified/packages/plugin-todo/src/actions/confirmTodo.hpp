 ...
 */
std::future<ConfirmationResponse> extractConfirmationIntent(IAgentRuntime runtime, Memory message, PendingTodoData | null pendingTask, State state);;
    }
 ...
 */
const confirmTodoAction: Action = {
  name: 'CONFIRM_TODO',
