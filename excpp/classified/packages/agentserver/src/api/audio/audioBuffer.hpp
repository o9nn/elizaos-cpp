...
std::future<Buffer | AudioProcessingResult> convertToAudioBuffer(const std::any& speechResponse, std::optional<bool> detectMimeType); else if (typeof speechResponse?.getReader === 'function') {
