                                            ...
                                            if (isDmChannel) {
                                                ...
                                                const auto newRootMessageData = {;
                                                    ...
                                                    const MessageService messageForBus = {;
                                                        ...
                                                        sourceId: createdRootMessage.sourceId, // Will be std::nullopt here, which is fine
                                                        };
                                                                    ...
                                                                    return {
                                                                        ...
                                                                        async (req: express.Request, res: express.Response) => {
                                                                            ...
                                                                            (router).post("/channels", async (req: express.Request, res: express.Response) => {
                                                                                ...
                                                                                const auto { name, type, source_type, sourceId, metadata, id } = req.body;
                                                                                                                ...
                                                                                                                if (providedDmServerId) {
                                                                                                                    ...
                                                                                                                    (router).post("/central-channels", async (req: express.Request, res: express.Response) => {
                                                                                                                        const auto {;
                                                                                                                            ...
                                                                                                                            const auto serverIdValue = serverId || server_id;

                                                                                                                            // Special handling for default server ID "0"
                                                                                                                            const auto isValidServerId = serverIdValue == DEFAULT_SERVER_ID || validateUuid(serverIdValue);
