 ...
 */
const agentExistsMiddleware = (agents: Map<UUID, IAgentRuntime>) => {
 ...
 */
const validateUuidMiddleware = (paramName: string) => {
  return (req: express.Request, res: express.Response, next: express.NextFunction) => {
 ...
 */
const validateChannelIdMiddleware = () => {
  return (req: express.Request, res: express.Response, next: express.NextFunction) => {
 ...
 */
const validateContentTypeMiddleware = () => {
  return (req: express.Request, res: express.Response, next: express.NextFunction) => {
 ...
 */
const createFileSystemRateLimit = () => {
  return rateLimit({
 ...
 */
const createChannelValidationRateLimit = () => {
  return rateLimit({
