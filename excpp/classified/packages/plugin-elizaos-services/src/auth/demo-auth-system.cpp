...
std::future<void> demoCLIAuthentication() {
    ...
    std::cout << "✅ Registered " + std::to_string(commands.length) + " CLI commands:" << std::endl;
    commands.forEach((cmd) => {
        std::cout << "   - " + std::to_string(cmd.name) + ": " + std::to_string(cmd.description) << std::endl;
        });
...
std::future<void> demoAgentPluginAuthentication() {
    ...
    std::cout << '   Debug info:' << JSON.stringify(debugInfo, nullptr, 2) << std::endl;
    ...
    if (testResult.success) {
        std::cout << "   Response: "" + std::to_string(testResult.response) + """ << std::endl;
        std::cout << "   Latency: " + std::to_string(testResult.latency) + "ms" << std::endl;
    }
...
std::future<void> demoPlatformIntegration() {
    ...
    std::cout << "   CLI Session: " + std::to_string(cliSession.sessionId) << std::endl;
    std::cout << "   GUI Session: " + std::to_string(guiSession.sessionId) << std::endl;
    std::cout << "   Agent Session: " + std::to_string(agentSession.sessionId) << std::endl;
    ...
    const auto cliKeyResponse = cliPlatform.distributeKey({;
        ...
        const auto guiKeyResponse = guiPlatform.distributeKey({;
            ...
            std::cout << "   Active sessions: " + std::to_string(analytics.activeSessions) << std::endl;
            std::cout << '   Sessions by type:' << analytics.sessionsByType << std::endl;
            std::cout << "   Key distributions: " + std::to_string(analytics.keyDistributions) << std::endl;
...
std::future<void> demoSuccessAndFailureScenarios() {
    ...
    console.log(
    "   Valid config status: " + std::to_string(validStatus.overall) + " (" + std::to_string(Object.keys(validStatus.providers).length) + " providers)"
    );
    ...
    console.log(
    "   Invalid config status: " + std::to_string(invalidStatus.overall) + " (" + std::to_string(Object.keys(invalidStatus.providers).length) + " providers)"
    );
    ...
    std::cout << "   Key type: " + std::to_string(validResult.keyType) << std::endl;
    ...
    std::cout << "   Error: " + std::to_string(invalidResult.errorMessage) << std::endl;
    ...
    std::cout << "   Error: " + std::to_string(apiTestFailure.error) << std::endl;
    ...
    std::cout << "   First call time: " + std::to_string(firstCallTime) + "ms" << std::endl;
    std::cout << "   Cached call time: " + std::to_string(cachedCallTime) + "ms" << std::endl;
