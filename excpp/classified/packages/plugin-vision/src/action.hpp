...
const describeSceneAction: Action = {
  name: 'DESCRIBE_SCENE',
...
const captureImageAction: Action = {
  name: 'CAPTURE_IMAGE',
...
const setVisionModeAction: Action = {
...
const identifyPersonAction: Action = {
...
const trackEntityAction: Action = {
  name: 'TRACK_ENTITY',
