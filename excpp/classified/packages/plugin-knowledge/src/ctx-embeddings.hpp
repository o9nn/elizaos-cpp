...
const DEFAULT_CHARS_PER_TOKEN = 3.5; // Approximation for English text
...
const SYSTEM_PROMPTS = {
  ...
  CODE: 'You are a precision code augmentation tool. Your task is to expand a given code chunk with necessary context from the larger codebase. You must: 1) Keep the original code chunk intact with exact syntax and indentation; 2) Add relevant imports, 
</document>
 ...
 */
const CACHED_CHUNK_PROMPT_TEMPLATE = `
Here is the chunk we want to situate within the whole document:
<chunk>
{chunk_content}
</chunk>
 ...
 */
const CACHED_CODE_CHUNK_PROMPT_TEMPLATE = `
...
2. Include any import statements,  and {max_tokens} tokens
 ...
 */
const CACHED_MATH_PDF_PROMPT_TEMPLATE = `
Here is the chunk we want to situate within the whole document:
<chunk>
{chunk_content}
</chunk>
 ...
 */
const CACHED_TECHNICAL_PROMPT_TEMPLATE = `
Here is the chunk we want to situate within the whole document:
<chunk>
{chunk_content}
</chunk>
 ...
 */
const MATH_PDF_PROMPT_TEMPLATE = `
<document>
{doc_content}
</document>
 ...
 */
const TECHNICAL_PROMPT_TEMPLATE = `
<document>
{doc_content}
</document>
