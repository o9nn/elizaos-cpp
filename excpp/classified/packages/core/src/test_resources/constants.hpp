...
const SERVER_URL = 'http://localhost:7998';
const SUPABASE_URL = 'https://pronvzrzfwsptkojvudd.supabase.co';
...
const TEST_PASSWORD = 'mock_password_123!@#';
const TEST_EMAIL_2 = 'testuser234@example.com';
const TEST_PASSWORD_2 = 'mock_password_234!@#';
