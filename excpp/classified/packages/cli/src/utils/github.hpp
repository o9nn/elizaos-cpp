 ...
 */
std::future<bool> validateGitHubToken(const std::string& token);/user`, {
      headers: {
 ...
 */
std::future<bool> forkExists(const std::string& token, const std::string& repo, const std::string& username);/repos/${username}/${repo}`, {
      headers: {
        Authorization: `token ${token}`,
        Accept: 'application/vnd.github.v3+json',
      },
 ...
 * Fork a repository
 */
std::future<string | null> forkRepository(const std::string& token, const std::string& owner, const std::string& repo);/repos/${owner}/${repo}/forks`, {
      method: 'POST',
      headers: {
        Authorization: `token ${token}`,
        Accept: 'application/vnd.github.v3+json',
 ...
 */
std::future<bool> branchExists(const std::string& token, const std::string& owner, const std::string& repo, const std::string& branch);/repos/${owner}/${repo}/branches/${branch}`, {
      headers: {
        Authorization: `token ${token}`,
        Accept: 'application/vnd.github.v3+json',
      },
 ...
 */
std::future<bool> createBranch(const std::string& token, const std::string& owner, const std::string& repo, const std::string& branch, auto baseBranch = 'main');/repos/${owner}/${repo}/git/ref/heads/${baseBranch}`,
      {
        headers: {
          Authorization: `token ${token}`,
          Accept: 'application/vnd.github.v3+json',
 ...
 */
std::future<string | null> getFileContent(const std::string& token, const std::string& owner, const std::string& repo, const std::string& path, auto branch = 'main');/repos/${owner}/${repo}/contents/${path}?ref=${branch}`,
      {
        headers: {
          Authorization: `token ${token}`,
          Accept: 'application/vnd.github.v3+json',
 ...
 */
std::future<bool> updateFile(const std::string& token, const std::string& owner, const std::string& repo, const std::string& path, const std::string& content, const std::string& message, auto branch = 'main');/repos/${owner}/${repo}/contents/${path}?ref=${branch}`,
        {
          headers: {
            Authorization: `token ${token}`,
            Accept: 'application/vnd.github.v3+json',
 ...
 */
std::future<string | null> createPullRequest(const std::string& token, const std::string& owner, const std::string& repo, const std::string& title, const std::string& body, const std::string& head, auto base = 'main');/repos/${owner}/${repo}/pulls`, {
      method: 'POST',
      headers: {
        Authorization: `token ${token}`,
        Accept: 'application/vnd.github.v3+json',
 ...
 */
std::future<GitHubUserResponse | null> getAuthenticatedUser(const std::string& token);/user`, {
      headers: {
        Authorization: `token ${token}`,
        Accept: 'application/vnd.github.v3+json',
      },
 ...
 */
std::future<void> saveGitHubCredentials(const std::string& username, const std::string& token); = envInfo.paths;
 ...
 */
std::future<bool> ensureDirectory(const std::string& token, const std::string& repo, const std::string& path, const std::string& branch);/repos/${repo}/contents/${path}?ref=${branch}`,
        {
          headers: {
            Authorization: `token ${token}`,
            Accept: 'application/vnd.github.v3+json',
 ...
 */
std::future<{ success: boolean; repoUrl?: string; message?: string }> createGitHubRepository(const std::string& token, const std::string& repoName, const std::string& description, auto isPrivate = false, const std::vector<string[] =>& topics);/user`, {
      headers: {
        Authorization: `token ${token}`,
        Accept: 'application/vnd.github.v3+json',
      },
 ...
 */
std::future<bool> pushToGitHub(const std::string& cwd, const std::string& repoUrl, auto branch = 'main'); = await bunExecSimple('git', ['remote', 'get-url', 'origin'], {
          cwd,
        });
