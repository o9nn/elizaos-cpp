    ...
    try {
        ...
        try {
            ...
            if (!envExists) {
                ...
                if (!isQuietMode()) {
                    std::cout << "[Config] Created .env file with template variables at: " + std::to_string(envFilePath) << std::endl;
                }
                } else {
                    ...
                    if (trimmedContent == '') {
                        ...
                        logger.info(
                        "[Config] Populated empty .env file with template variables at: " + std::to_string(envFilePath)
                        );
                        } else {
