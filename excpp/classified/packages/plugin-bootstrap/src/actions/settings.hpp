 ...
 */
std::future<std::vector<SettingUpdate>> extractSettingValues(IAgentRuntime runtime, Memory _message, State state, WorldSettings worldSettings); = categorizeSettings(worldSettings);
 ...
 */
std::future<{ updatedAny: boolean; messages: string[] }> processSettingUpdates(IAgentRuntime runtime, const std::string& serverId, WorldSettings worldSettings, const std::vector<SettingUpdate>& updates);;
  }
 ...
 */
std::future<ActionResult> generateSuccessResponse(IAgentRuntime runtime, WorldSettings worldSettings, State state, const std::vector<std::string>& messages, HandlerCallback callback); = categorizeSettings(worldSettings);
 ...
 */
std::future<ActionResult> generateFailureResponse(IAgentRuntime runtime, WorldSettings worldSettings, State state, HandlerCallback callback); = categorizeSettings(worldSettings);
