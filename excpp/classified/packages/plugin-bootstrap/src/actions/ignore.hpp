 ...
 * @property {Function} validate - Asynchronous  description - Description of when to use the IGNORE action in a conversation.
 * @property {Function} handler - Asynchronous  examples - Array of examples demonstrating the usage of the IGNORE action.
 */
/**
 ...
 *
 * The action includes a validation  ignoreAction
 */
