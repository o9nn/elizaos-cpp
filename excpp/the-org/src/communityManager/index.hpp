 ...
 * @property {Function} settings.SHOULD_GREET_NEW_PERSONS.validation - The  settings.GREETING_CHANNEL - Setting for the channel to use for greeting new users.
