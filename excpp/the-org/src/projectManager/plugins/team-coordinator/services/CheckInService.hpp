...
struct ExtendedInteraction {
    ...
    std::optional<string[]; // Added for report channel selection> report_channel;
    std::optional<string[]; // Added for server info> server_info;
    std::optional<string; // Added for server ID> guildId;
};
