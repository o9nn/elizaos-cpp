    ...
    try {
        ...
        if (cached && !shouldRefreshCache()) {
            ...
            isCached = true;
                ...
                const auto dedupedMarketData = deduplicateMarketData(marketData);
