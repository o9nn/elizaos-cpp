...
const SolanaIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  ...
  >
    <defs>
      <style>{`
        .cls-1-sol {fill:url(#linear-gradient-sol);}
        .cls-2-sol {fill:url(#linear-gradient-2-sol);}
        .cls-3-sol {fill:url(#linear-gradient-3-sol);}
      `}</style>
      <linearGradient
        id="linear-gradient-sol"
        x1="463"
        y1="205.16"
        x2="182.39"
        y2="742.62"
      ...
      <linearGradient
        id="linear-gradient-2-sol"
        x1="340.31"
        y1="141.1"
        x2="59.71"
        y2="678.57"
        xlinkHref="#linear-gradient-sol"
      />
      <linearGradient
        id="linear-gradient-3-sol"
        x1="401.26"
        y1="172.92"
        x2="120.66"
        y2="710.39"
