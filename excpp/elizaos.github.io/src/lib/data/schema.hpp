...
const walletAddresses = sqliteTable(
  "wallet_addresses",
  {
...
const repositories = sqliteTable(
  "repositories",
  {
...
const rawPullRequests = sqliteTable(
  "raw_pull_requests",
  {
...
const rawPullRequestFiles = sqliteTable(
  "raw_pr_files",
  {
...
const rawCommitFiles = sqliteTable(
  "raw_commit_files",
  {
...
const issueComments = sqliteTable(
  "issue_comments",
  {
    id: text("id").primaryKey(),
...
const userSummaries = sqliteTable(
  "user_summaries",
  {
...
const repoSummaries = sqliteTable(
  "repo_summaries",
  {
...
const userTagScores = sqliteTable(
  "user_tag_scores",
  {
    id: text("id").primaryKey(),
...
const pullRequestLabels = sqliteTable(
  "pull_request_labels",
  {
    prId: text("pr_id")
      .notNull()
...
const userDailyScores = sqliteTable(
  "user_daily_scores",
  {
...
const walletAddressesRelations = relations(
  walletAddresses,
  ({ one }) => ({
    user: one(users, {
...
const pullRequestRelations = relations(
  rawPullRequests,
  ({ one, many }) => ({
    author: one(users, {
...
const pullRequestFilesRelations = relations(
  rawPullRequestFiles,
  ({ one }) => ({
...
const issuesRelations = relations(rawIssues, ({ one, many }) => ({
  author: one(users, {
...
const commitsRelations = relations(rawCommits, ({ one, many }) => ({
  author: one(users, {
...
const commitFilesRelations = relations(rawCommitFiles, ({ one }) => ({
...
const prReviewsRelations = relations(prReviews, ({ one }) => ({
  pullRequest: one(rawPullRequests, {
...
const prCommentsRelations = relations(prComments, ({ one }) => ({
  pullRequest: one(rawPullRequests, {
...
const issueCommentsRelations = relations(issueComments, ({ one }) => ({
  issue: one(rawIssues, {
...
const userDailySummariesRelations = relations(
  userSummaries,
  ({ one }) => ({
    user: one(users, {
...
const userTagScoresRelations = relations(userTagScores, ({ one }) => ({
  user: one(users, {
...
const pullRequestLabelsRelations = relations(
  pullRequestLabels,
  ({ one }) => ({
    pullRequest: one(rawPullRequests, {
...
const issueLabelsRelations = relations(issueLabels, ({ one }) => ({
  issue: one(rawIssues, {
...
const repoSummariesRelations = relations(repoSummaries, ({ one }) => ({
...
const userDailyScoresRelations = relations(
  userDailyScores,
  ({ one }) => ({
    user: one(users, {
...
const prCommentReactions = sqliteTable(
...
// Reactions on issues
const issueReactions = sqliteTable(
  "issue_reactions",
  {
    id: text("id").primaryKey(),
    issueId: text("issue_id")
...
const issueCommentReactions = sqliteTable(
...
const prClosingIssueReferences = sqliteTable(
