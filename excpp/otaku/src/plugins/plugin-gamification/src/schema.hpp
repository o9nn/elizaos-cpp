 ...
 */
const gamificationEventsTable = pgTable('gamification_events', {
 ...
 */
const pointBalancesTable = pgTable('point_balances', {
 ...
 */
const userChainHistoryTable = pgTable('user_chain_history', {
  userId: uuid('user_id').notNull(),
 ...
 */
const gamificationCampaignsTable = pgTable('gamification_campaigns', {
 ...
 */
const leaderboardSnapshotsTable = pgTable('leaderboard_snapshots', {
