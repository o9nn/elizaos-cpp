 ...
 */
const BASE_POINTS: Record<GamificationEventType, number> = {
 ...
 */
const DAILY_CAPS: Partial<Record<GamificationEventType, number>> = {
 ...
 */
const DAILY_QUEST_UNIQUE_ACTIONS_REQUIRED = 3;

/**
 * Referral activation window (days)
 */
const REFERRAL_ACTIVATION_WINDOW_DAYS = 7;
