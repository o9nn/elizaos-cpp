...
express::Router createChannelsRouter(ElizaOS elizaOS, AgentServer serverInstance) {
    ...
    try {
        ...
        const auto getParticipants = async (channelId: UUID) =>;
        serverInstance.getChannelParticipants(channelId);
                                                            ...
                                                            try {
                                                                ...
                                                                const auto messagesForGui = messages.map((msg) => {;
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        const auto { content, metadata } = transformMessageAttachments({;
                                                                            content: msg.content,
                                                                            metadata: {
                                                                                ...msg.metadata,
                                                                                ...
                                                                                async (req: express.Request, res: express.Response) => {
                                                                                    ...
                                                                                    (router).post('/channels', requireAuthenticated(), async (req: express.Request, res: express.Response) => {
                                                                                                    ...
                                                                                                    if (!validateUuid(serverId)) {
                                                                                                        ...
                                                                                                        try {
                                                                                                            const auto channel = serverInstance.createChannel({;
                                                                                                                ...
                                                                                                                (router).get('/dm-channel', requireAuthenticated(), async (req: AuthenticatedRequest, res: express.Response) => {
                                                                                                                    ...
                                                                                                                    try {
                                                                                                                        if (providedDmServerId) {
                                                                                                                            ...
                                                                                                                            res.json({ success: true, data: channel });
                                                                                                                                ...
                                                                                                                                std::cerr << 'Error finding/creating DM channel:' << JSON.stringify(errorDetails) << std::endl;
                                                                                                                            ...
                                                                                                                            (router).post('/central-channels', requireAuthenticated(), async (req: express.Request, res: express.Response) => {
                                                                                                                                const auto {;
                                                                                                                                    name,
                                                                                                                                                    ...
                                                                                                                                                    async (req: express.Request, res: express.Response) => {
                                                                                                                                                        ...
                                                                                                                                                        try {
                                                                                                                                                            ...
                                                                                                                                                            res.json({ success: true, data: channelDetails });
                                                                                                                                                                ...
                                                                                                                                                                logger.error(
                                                                                                                                                                "[Messages Router] Error fetching details for channel " + std::to_string(channelId) + ":"
                                                                                                                                                                true /* instanceof check */ ? error.message : std::to_string(error)
                                                                                                                                                                );
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                res.json({
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    data: {
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        // TODO: Add agent-specific filtering when agent registry is available
                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            logger.error(
                                                                                                                                                                                                                                            "[Messages Router] Error fetching agents for channel " + std::to_string(channelId) + ":"
                                                                                                                                                                                                                                            true /* instanceof check */ ? error.message : std::to_string(error)
                                                                                                                                                                                                                                            );
                                                                                                                                                                                                                                            res.status(500).json({
                                                                                                                                                                                                                                                success: false,
                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                            const auto channelClearedPayload = {;
                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                if (serverInstance.socketIO) {
                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                    res.status(204).send();
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        logger.error(
                                                                                                                                                                                                                                                                        "[Messages Router] Error clearing messages for channel " + std::to_string(channelId) + ":"
                                                                                                                                                                                                                                                                        true /* instanceof check */ ? error.message : std::to_string(error)
                                                                                                                                                                                                                                                                        );
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        const auto updatedChannel = serverInstance.updateChannel(channelId, {;
                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                            if (serverInstance.socketIO) {
                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                res.json({ success: true, data: updatedChannel });
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    logger.error(
                                                                                                                                                                                                                                                                                    "[Messages Router] Error updating channel " + std::to_string(channelId) + ":"
                                                                                                                                                                                                                                                                                    true /* instanceof check */ ? error.message : std::to_string(error)
                                                                                                                                                                                                                                                                                    );
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    const auto channelClearedPayload = {;
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        if (serverInstance.socketIO) {
                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                            res.status(204).send();
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                logger.error(
                                                                                                                                                                                                                                                                                                "[Messages Router] Error deleting channel " + std::to_string(channelId) + ":"
                                                                                                                                                                                                                                                                                                true /* instanceof check */ ? error.message : std::to_string(error)
                                                                                                                                                                                                                                                                                                );
                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                            if (!agentId || !validateUuid(agentId)) {
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                try {
                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                    if (!runtime) {
                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                        std::cout << "[TITLE GENERATION] Generating title from user message: "" + std::to_string(userMessage) + """ << std::endl;
                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                        if (!newTitle || newTitle.trim().length == 0) {
                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                            return res.json({;
                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                std::cout << "[TITLE GENERATION] Generated title: "" + std::to_string(cleanTitle) + """ << std::endl;
                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                if (!agentId || !validateUuid(agentId)) {
                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                    try {
                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                        if (!runtime) {
                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                            std::cout << "[PROMPT GENERATION] Generating " + std::to_string(count) + " quick start prompts for channel " + std::to_string(channelId) << std::endl;

                                                                                                                                                                                                                                                                                                                                                            // Get recent messages from the channel
                                                                                                                                                                                                                                                                                                                                                            const auto limit = 20; // Look at last 20 messages for context;
                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                            if (messages && messages.length > 0) {
                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                const auto promptTemplate = "# Task: Generate " + std::to_string(count);
                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                            **Rules:**
                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                            6. Write in first person the user is asking;
                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                            **Response Format (XML):**
                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                            const auto promptResult = runtime.useModel(ModelType.TEXT_SMALL, {;
                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                if (!promptResult || promptResult.trim().length == 0) {
                                                                                                                                                                                                                                                                                                                                                                    std::cout << "[PROMPT GENERATION] Failed to generate prompts for channel " + std::to_string(channelId) << std::endl;
                                                                                                                                                                                                                                                                                                                                                                    return res.status(200).json({;
                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                        try {
                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                            for (const auto& match : promptMatches)
                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                true /* instanceof check */ ? parseError.message : std::to_string(parseError)
                                                                                                                                                                                                                                                                                                                                                                                );
                                                                                                                                                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                            if (prompts.length == 0) {
                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                return res.status(200).json({;
                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                    std::cout << "[PROMPT GENERATION] Generated " + std::to_string(prompts.length) + " prompts for channel " + std::to_string(channelId) << std::endl;
