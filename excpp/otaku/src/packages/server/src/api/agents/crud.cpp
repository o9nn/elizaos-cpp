                                                                                                    ...
                                                                                                    if (needsRestart) {
                                                                                                        ...
                                                                                                        try {
                                                                                                            ...
                                                                                                            logger.success(`[AGENT UPDATE] Agent ${agentId} restarted successfully`);
                                                                                                                ...
                                                                                                                "[AGENT UPDATE] Failed to restart agent " + std::to_string(agentId) + ", attempting to restore previous state";
                                                                                                                );
                                                                                                                ...
                                                                                                                try {
                                                                                                                    ...
                                                                                                                    std::cout << "[AGENT UPDATE] Restored agent " + std::to_string(agentId) + " to previous state" << std::endl;
                                                                                                                    } catch (restoreError) {
                                                                                                                        logger.error(
                                                                                                                        { error: restoreError, agentId },
                                                                                                                        "[AGENT UPDATE] Failed to restore agent " + std::to_string(agentId) + " - agent may be in broken state";
                                                                                                                        );
                                                                                                                    }
                                                                                                            ...
                                                                                                            router.delete('/:agentId', requireAuth, requireAdmin, async (req: AuthenticatedRequest, res) => {
                                                                                                                ...
                                                                                                                try {
                                                                                                                    ...
                                                                                                                    logger.debug(`[AGENT DELETE] Agent found: ${agent.name} (${agentId})`);
                                                                                                                        ...
                                                                                                                        logger.error(
                                                                                                                        "[AGENT DELETE] Error checking if agent exists: " + std::to_string(agentId)
                                                                                                                                    ...
                                                                                                                                    if (runtime) {
                                                                                                                                        ...
                                                                                                                                        try {
                                                                                                                                            ...
                                                                                                                                            logger.debug(`[AGENT DELETE] Agent ${agentId} unregistered successfully`);
                                                                                                                                                ...
                                                                                                                                                logger.error(
                                                                                                                                                "[AGENT DELETE] Error stopping agent " + std::to_string(agentId) + ":"
