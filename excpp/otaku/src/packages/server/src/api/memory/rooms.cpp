                                ...
                                try {
                                    ...
                                    for (const auto& world : worlds)
                                        ...
                                        sendSuccess(res, { rooms: agentRooms });
                                            ...
                                            logger.error(
                                            "[ROOMS LIST] Error retrieving rooms for agent " + std::to_string(agentId) + ":"
                                            true /* instanceof check */ ? error.message : std::to_string(error)
                                            );
                                            sendError(;
                                            res,
                                            ...
                                            try {
                                                ...
                                                sendSuccess(res, {
                                                    ...
                                                    ...(worldName && { worldName }),
                                                        ...
                                                        logger.error(
                                                        "[ROOM DETAILS] Error retrieving room " + std::to_string(roomId) + " for agent " + std::to_string(agentId) + ":"
                                                        true /* instanceof check */ ? error.message : std::to_string(error)
                                                        );
                                                        sendError(;
                                                        res,
