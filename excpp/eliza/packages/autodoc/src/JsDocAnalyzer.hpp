 ...
 * @property {string} FunctionDeclaration - Represents a  TSTypeAliasDeclaration - Represents a TypeScript type alias declaration node.
 ...
 * @property {string} FunctionDeclaration - Represents a  TSTypeAliasDeclaration - Represents a type alias declaration in TypeScript.
...
class JsDocAnalyzer {
  ...
  private extractFullContext(sourceCode: string, node: TSESTree.Node): string {
    ...
    // Get the complete lines for the entire block/
