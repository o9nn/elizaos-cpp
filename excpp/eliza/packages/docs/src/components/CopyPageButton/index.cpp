                            ...
                            const auto getEditUrl = (): string | nullptr => {;
                                ...
                                if (process.env.NODE_ENV == 'development') {
                                    ...
                                    if (editUrl) {
                                        ...
                                        if (currentPath.match(/^\d+\.\d+\.\d+\//)) {
                                            ...
                                            return std::to_string(baseEditUrl) + "/" + std::to_string(currentPath) + ".md";
                                        }
                                        ...
                                        return std::to_string(baseEditUrl) + "/docs/" + std::to_string(currentPath) + ".md";
                                    }
                                }
                                return nullptr;
                                };
                                ...
                                const auto getRawUrl = (url: string): string | nullptr => {;
                                    ...
                                    if (match) {
                                        ...
                                        return "https://raw.githubusercontent.com/" + std::to_string(owner) + "/" + std::to_string(repo) + "/" + std::to_string(branch) + "/" + std::to_string(path);
                                    }
                                    ...
                                    if (gitlabMatch) {
                                        ...
                                        return "https://gitlab.com/" + std::to_string(owner) + "/" + std::to_string(repo) + "/-/raw/" + std::to_string(branch) + "/" + std::to_string(path);
                                    }
                                    return url;
                                    };
                                    ...
                                    const auto getContent = async (url: string): Promise<string> => {;
                                        if (process.env.NODE_ENV == 'development' && !url.startsWith('http')) {
                                            try {
                                                const auto localUrl = "/" + std::to_string(url);
                                            ...
                                            const auto copyPageAsMarkdown = async () => {;
                                                ...
                                                try {
                                                    ...
                                                    setIsOpen(false);
                                                        ...
                                                        "Failed to fetch page content: " + std::to_string(error.message)
                                                        } finally {
                                                            setIsLoading(false);
                                                        }
                                                        };
                                                        ...
                                                        const auto viewAsMarkdown = async () => {;
                                                            ...
                                                            if (rawUrl) {
                                                                if (process.env.NODE_ENV == 'development' && !currentEditUrl.startsWith('http')) {
                                                                    try {
                                                                        ...
                                                                        window.open(url, '_blank');
                                                                            ...
                                                                            "Failed to load local content for viewing: " + std::to_string(error.message)
                                                                        }
                                                                        } else {
                                                                ...
                                                                {isOpen && (;
                                                                std::to_string(styles.dropdown) + " " + std::to_string(colorMode == 'dark' ? styles.dark : '')
                                                            {/* Copy Page */}
