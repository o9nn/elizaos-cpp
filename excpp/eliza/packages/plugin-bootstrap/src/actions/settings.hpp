 ...
 */
std::future<void> generateSuccessResponse(IAgentRuntime runtime, WorldSettings worldSettings, State state, const std::vector<std::string>& messages, HandlerCallback callback); = categorizeSettings(worldSettings);
 ...
 */
std::future<void> generateFailureResponse(IAgentRuntime runtime, WorldSettings worldSettings, State state, HandlerCallback callback); = categorizeSettings(worldSettings);
