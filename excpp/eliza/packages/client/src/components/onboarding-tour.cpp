...
void OnboardingTour() {
    ...
    const auto { onboardingCompleted, completeOnboarding } = useOnboarding();
    const auto [run, setRun] = useState(false);
    const auto location = useLocation();
    const auto [tourStep, setTourStep] = useState(0);

    // Home page tour steps
    const auto homeSteps = [;
    {
        target: '.sidebar-logo',
        content:
                                                    ...
                                                    const auto createAgentSteps = [;
                                                    {
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            },
                                                            {
                                                                target: '.tabs-list',
                                                                content:
                                                                'Switch between these tabs to configure different aspects of your agent such, style, plugins, and appearance.',
                                                                            ...
                                                                            const auto timer = setTimeout(() => {;
                                                                                ...
                                                                                return [&]() { return clearTimeout(timer); };
                                                                                    ...
                                                                                    const auto timer = setTimeout(() => {;
                                                                                        ...
                                                                                        // Handle tour events
                                                                                        const auto handleJoyrideCallback = [&](data: CallBackProps) {;
