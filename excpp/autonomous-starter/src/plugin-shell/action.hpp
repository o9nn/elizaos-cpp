...
const runShellCommandAction: Action = {
  ...
  handler: async (
    ...
    // Apply quoting for wildcards using the new helper 
...
const clearShellHistoryAction: Action = {
...
const killAutonomousAction: Action = {
