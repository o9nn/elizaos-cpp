...
const BIRDEYE_SUPPORTED_CHAINS = [
    "solana",
    "ethereum",
    "arbitrum",
    "avalanche",
...
const CHAIN_ALIASES: Record<string, BirdeyeSupportedChain> = {
    // Solana
    sol: "solana",
...
// Helper functions
const extractChain = (text: string): BirdeyeSupportedChain => {
...
const extractAddresses = (text: string): BaseAddress[] => {
...
const extractTimeframe = (text: string): Timeframe => {
...
const formatPortfolio = (response: WalletPortfolioResponse) => {
...
const convertToStringParams = (params: BirdeyeApiParams) => {
...
const getTokenResultFromSearchResponse = (
