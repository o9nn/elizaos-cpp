...
: AcceptQuoteModalProps) {
  ...
  std::future<bigint> readNextOfferId();`,
      abi: abi as Abi,
  ...
  std::future<OfferTuple> readOffer(bigint offerId);`,
      abi: abi as Abi,
      functionName: "offers",
      args: [offerId],
    })) as OfferTuple;
  ...
  std::future<`0x${string}` | undefined> fulfillWithRetry(bigint offerId);
