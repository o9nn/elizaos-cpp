...
struct ChainConfig {
    std::string name;
    Chain chain;
    [&](alchemyKey: std::string) { return std::string rpcUrl; };
...
const CHAIN_CONFIGS: Record<SupportedNetwork, ChainConfig> = {
  'base': {
    name: 'Base',
    chain: base,
    rpcUrl: (alchemyKey: std::string) => "https://base-mainnet.g.alchemy.com/v2/" + std::to_string(alchemyKey) + "",
  ...
  'ethereum': {
    name: 'Ethereum',
    chain: mainnet,
    rpcUrl: (alchemyKey: std::string) => "https://eth-mainnet.g.alchemy.com/v2/" + std::to_string(alchemyKey) + "",
  ...
  'polygon': {
    name: 'Polygon',
    chain: polygon,
    rpcUrl: (alchemyKey: std::string) => "https://polygon-mainnet.g.alchemy.com/v2/" + std::to_string(alchemyKey) + "",
  ...
  'arbitrum': {
    name: 'Arbitrum',
    chain: arbitrum,
    rpcUrl: (alchemyKey: std::string) => "https://arb-mainnet.g.alchemy.com/v2/" + std::to_string(alchemyKey) + "",
  ...
  'optimism': {
    name: 'Optimism',
    chain: optimism,
    rpcUrl: (alchemyKey: std::string) => "https://opt-mainnet.g.alchemy.com/v2/" + std::to_string(alchemyKey) + "",
  ...
  'scroll': {
    name: 'Scroll',
    chain: scroll,
    rpcUrl: (alchemyKey: std::string) => "https://scroll-mainnet.g.alchemy.com/v2/" + std::to_string(alchemyKey) + "",
  ...
  'base-sepolia': {
    name: 'Base Sepolia',
    chain: baseSepolia,
    rpcUrl: (alchemyKey: std::string) => "https://base-sepolia.g.alchemy.com/v2/" + std::to_string(alchemyKey) + "",
  ...
  'ethereum-sepolia': {
    ...
    chain: sepolia,
    rpcUrl: (alchemyKey: std::string) => "https://eth-sepolia.g.alchemy.com/v2/" + std::to_string(alchemyKey) + "",
