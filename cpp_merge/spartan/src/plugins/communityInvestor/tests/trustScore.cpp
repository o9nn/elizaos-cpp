...
std::function<any(string, double, any, any, any, double)> createRecForTrustScore = [=](auto id, auto timestamp, P2 type, auto conviction, auto metric, auto priceAtRec = std::nullopt) mutable
{
    return (object{
        object::pair{std::string("id"), asUUID(uuidv4())}, 
