#ifndef _HOME_RUNNER_WORK_ELIZAOS_CPP_ELIZAOS_CPP_SPARTAN_SRC_PLUGINS_DEGENINTEL_TASKS_TSK_PRICE_DELTA_SIGNAL_H
#define _HOME_RUNNER_WORK_ELIZAOS_CPP_ELIZAOS_CPP_SPARTAN_SRC_PLUGINS_DEGENINTEL_TASKS_TSK_PRICE_DELTA_SIGNAL_H
#include "core.hpp"
