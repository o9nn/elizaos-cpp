#ifndef _HOME_RUNNER_WORK_ELIZAOS_CPP_ELIZAOS_CPP_ELIZAS_LIST_SRC_LIB_REPORTING_AUTOMATED_REPORTS_H
#define _HOME_RUNNER_WORK_ELIZAOS_CPP_ELIZAOS_CPP_ELIZAS_LIST_SRC_LIB_REPORTING_AUTOMATED_REPORTS_H
#include "core.hpp"
#include "jspdf.hpp"
