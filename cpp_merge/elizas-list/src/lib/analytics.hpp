...
public:
    ...
    static void trackProjectView(string projectId, string userId = std::nullopt);
    static void trackRelatedProjectClick(string sourceProjectId, string targetProjectId, string userId = std::nullopt);
};
