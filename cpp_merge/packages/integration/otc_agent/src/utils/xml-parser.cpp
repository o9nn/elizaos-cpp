...
any parseOTCQuoteXML(string xmlString)
{
    ...
    return object{
        ...
        object::pair{std::string("tokenChain"), (tokenChain) ? any((as<any>(tokenChain))) (std::nullopt)}, 
        ...
        object::pair{std::string("ethPrice"), OR((getElementNumber(std::string("ethPrice"))), (std::nullopt))}, 
        object::pair{std::string("createdAt"), getElementText(std::string("createdAt"))}, 
        object::pair{std::string("status"), OR((getElementText(std::string("status"))), (std::nullopt))}, 
