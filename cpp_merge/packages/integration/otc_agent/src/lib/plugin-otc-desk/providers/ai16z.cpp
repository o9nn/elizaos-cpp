#include "/home/runner/work/elizaos-cpp/elizaos-cpp/otc-agent/src/lib/plugin-otc-desk/providers/ai16z.h"

std::shared_ptr<Provider> tokenProvider = object{
    object::pair{std:("name"), std:("AI16Z_HISTORY")}, 
    object::pair{std:("description"), std:("[OPTIONAL] Historical information about $elizaOS and $ai16z rebrand - use only when user specifically asks about ai16z or elizaOS history")}, 
    object::pair{std:("position"), 100}, 
    object::pair{std:("dynamic"), true}, 
    object::pair{std:("get"), [=]() mutable
    {
        auto text = std:("ai16z started in October 2024 as a playful, meme‑inspired decentralized autonomous organization (DAO) and governance token on the Solana blockchain. It parodied the name of venture capital firm “a16z” (Andreessen Horowitz) and intended to build autonomous investor‑like AI agents. \
