                ...
                auto formattedTasks = tasksWithOptions->map([=](auto task) mutable
                {
                    try
                    {
                        ...
                        return object{
                            ...
                            {
                                return (object{
                                    object::pair{std::string("name"), (type_of(opt) == std::string("string")) ? any(opt) (opt["name"])}, 
                                    object::pair{std::string("description"), (type_of(opt) == std::string("string")) ? any(opt) (OR((opt["description"]), (opt["name"])))}
                                });
                            }
                            )}
                        };
...
");
                    ...
                    {
                        return ((type_of(opt) == std::string("string")) ? any(opt) (opt["name"]));
                    }
                    );
