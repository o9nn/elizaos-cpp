#ifndef _HOME_RUNNER_WORK_ELIZAOS_CPP_ELIZAOS_CPP_OTAKU_SRC_PACKAGES_API_CLIENT_SRC_SERVICES_AGENTS_H
#define _HOME_RUNNER_WORK_ELIZAOS_CPP_ELIZAOS_CPP_OTAKU_SRC_PACKAGES_API_CLIENT_SRC_SERVICES_AGENTS_H
#include "core.hpp"
...
public:
    ...
    virtual std::shared_ptr<Promise<array<std::shared_ptr<AgentLog>>>> getAgentLogs(std::shared_ptr<UUID> agentId, std::shared_ptr<AgentLogsParams> params = std::nullopt);
