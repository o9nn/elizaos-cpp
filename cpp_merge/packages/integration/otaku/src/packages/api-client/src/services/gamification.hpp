#ifndef _HOME_RUNNER_WORK_ELIZAOS_CPP_ELIZAOS_CPP_OTAKU_SRC_PACKAGES_API_CLIENT_SRC_SERVICES_GAMIFICATION_H
#define _HOME_RUNNER_WORK_ELIZAOS_CPP_ELIZAOS_CPP_OTAKU_SRC_PACKAGES_API_CLIENT_SRC_SERVICES_GAMIFICATION_H
#include "core.hpp"
#include <string>
...
public:
    ...
    std::shared_ptr<Promise<std::shared_ptr<LeaderboardResponse>>> getLeaderboard(std::shared_ptr<UUID> agentId, P1 scope = std::string("weekly"), double limit = 50, std::shared_ptr<UUID> userId = std::nullopt);
