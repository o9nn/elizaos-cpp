...
RET getEntityWallet(std::shared_ptr<IAgentRuntime> runtime, std::shared_ptr<Memory> message, string actionName, std::shared_ptr<HandlerCallback> callback = std::nullopt);
