...
- **Next Milestone:** ") + summary->nextMilestone["pointsNeeded"]->toLocaleString() + std::string(" points to ") + summary->nextMilestone["levelName"] + string_empty) (string_empty) + string_empty;
            std::async([=]() { callback(object{
