#ifndef _HOME_RUNNER_WORK_ELIZAOS_CPP_ELIZAOS_CPP_OTAKU_SRC_PLUGINS_PLUGIN_CLANKER_SRC_TYPES_INDEX_H
#define _HOME_RUNNER_WORK_ELIZAOS_CPP_ELIZAOS_CPP_OTAKU_SRC_PLUGINS_PLUGIN_CLANKER_SRC_TYPES_INDEX_H
#include "core.hpp"
#include <string>
#include "ethers.hpp"
#include "zod.hpp"
...
enum struct ErrorCode {
    VALIDATION_ERROR = std::string("VALIDATION_ERROR"), NETWORK_ERROR = std::string("NETWORK_ERROR"), PROTOCOL_ERROR = std::string("PROTOCOL_ERROR"), SECURITY_ERROR = std::string("SECURITY_ERROR"), INSUFFICIENT_BALANCE = std::string("INSUFFICIENT_BALANCE"), SLIPPAGE_EXCEEDED = std::string("SLIPPAGE_EXCEEDED"), TRANSACTION_FAILED = std::string("TRANSACTION_FAILED"), UNAUTHORIZED = std::string("UNAUTHORIZED")
};
