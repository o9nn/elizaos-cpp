...
- Price Change: ") + (priceChange) ? any(string_empty + (priceChange["value"] >= 0) ? std::string("+") : string_empty + std::string("$") + priceChange["value"]->toFixed(6) + std::string(" (") + (priceChange["percentage"] >= 0) ? std::string("+") : string_empty + string_empty + priceChange["percentage"]->toFixed(2) + std::string("%)")) (std::string("N/A")) + std::string("\
- Current Market Cap: ") + (chartData["current_market_cap"]) ? any(std::string("$") + formatMarketCap(chartData["current_market_cap"]) + string_empty) (std::string("N/A")) + std::string("\
- Market Cap Change: ") + (marketCapChange) ? any(string_empty + (marketCapChange["value"] >= 0) ? std::string("+") : string_empty + std::string("$") + formatMarketCap(Math->abs(marketCapChange["value"])) + std::string(" (") + (marketCapChange["percentage"] >= 0) ? std::string("+") : string_empty + string_empty + marketCapChange["percentage"]->toFixed(2) + std::string("%)")) (std::string("N/A")) + std::string("\
