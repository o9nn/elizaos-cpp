#ifndef _HOME_RUNNER_WORK_ELIZAOS_CPP_ELIZAOS_CPP_HAT_SRC_COMPONENTS_PHOTOEDITOR_TYPES_H
#define _HOME_RUNNER_WORK_ELIZAOS_CPP_ELIZAOS_CPP_HAT_SRC_COMPONENTS_PHOTOEDITOR_TYPES_H
#include "core.hpp"
