#ifndef _HOME_RUNNER_WORK_ELIZAOS_CPP_ELIZAOS_CPP_ELIZA_PACKAGES_PLUGIN_STARTER_SRC___TESTS___E2E_STARTER_PLUGIN_H
#define _HOME_RUNNER_WORK_ELIZAOS_CPP_ELIZAOS_CPP_ELIZA_PACKAGES_PLUGIN_STARTER_SRC___TESTS___E2E_STARTER_PLUGIN_H
#include "core.hpp"
