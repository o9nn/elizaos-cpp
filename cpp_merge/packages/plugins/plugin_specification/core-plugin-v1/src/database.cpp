...
IDatabaseAdapter fromV2DatabaseAdapter(std::shared_ptr<IDatabaseAdapterV2> adapterV2)
{
    return object{
        ...
        object::pair{std::string("getMemoriesByIds"), [=](auto ids, auto tableName = std::nullopt) mutable
        {
        ...
        object::pair{std::string("createMemory"), [=](auto memory, auto tableName, auto unique = std::nullopt) mutable
        {
        ...
        object::pair{std::string("countMemories"), [=](auto roomId, auto unique = std::nullopt, auto tableName = std::nullopt) mutable
        {
        ...
        object::pair{std::string("createRoom"), [=](auto roomId = std::nullopt) mutable
        {
            auto room = object{
        ...
        object::pair{std::string("clearKnowledge"), [=](auto agentId, auto shared = std::nullopt) mutable
        {
