#ifndef _HOME_RUNNER_WORK_ELIZAOS_CPP_ELIZAOS_CPP_ELIZA_PACKAGES_CORE_SRC_TYPES_DATABASE_H
#define _HOME_RUNNER_WORK_ELIZAOS_CPP_ELIZAOS_CPP_ELIZA_PACKAGES_CORE_SRC_TYPES_DATABASE_H
#include "core.hpp"
#include "./agent.h"
...
public:
    ...
    virtual std::shared_ptr<Promise<void>> initialize(any config = std::nullopt) = 0;
    virtual std::shared_ptr<Promise<void>> init() = 0;
    virtual std::shared_ptr<Promise<void>> runMigrations(any schema = std::nullopt, string pluginName = std::nullopt) = 0;
    ...
    virtual std::shared_ptr<Promise<any>> getEntityByIds(array<std::shared_ptr<UUID>> entityIds) = 0;
    virtual std::shared_ptr<Promise<array<std::shared_ptr<Entity>>>> getEntitiesForRoom(std::shared_ptr<UUID> roomId, boolean includeComponents = std::nullopt) = 0;
    ...
    virtual std::shared_ptr<Promise<any>> getComponent(std::shared_ptr<UUID> entityId, string type, std::shared_ptr<UUID> worldId = std::nullopt, std::shared_ptr<UUID> sourceEntityId = std::nullopt) = 0;
    virtual std::shared_ptr<Promise<array<std::shared_ptr<Component>>>> getComponents(std::shared_ptr<UUID> entityId, std::shared_ptr<UUID> worldId = std::nullopt, std::shared_ptr<UUID> sourceEntityId = std::nullopt) = 0;
    ...
    virtual std::shared_ptr<Promise<array<std::shared_ptr<Memory>>>> getMemoriesByIds(array<std::shared_ptr<UUID>> ids, string tableName = std::nullopt) = 0;
    ...
    virtual std::shared_ptr<Promise<std::shared_ptr<UUID>>> createMemory(std::shared_ptr<Memory> memory, string tableName, boolean unique = std::nullopt) = 0;
    ...
    virtual std::shared_ptr<Promise<double>> countMemories(std::shared_ptr<UUID> roomId, boolean unique = std::nullopt, string tableName = std::nullopt) = 0;
