#include "/home/runner/work/elizaos-cpp/elizaos-cpp/eliza/packages/core/src/specs/v2/__tests__/messages.test.h"
...
void Main(void)
{
    describe(std:("Messages Library"), [=]() mutable
    {
        ...
        beforeAll([=]() mutable
        {
            runtime = as<any>(as<any>(object{
                object::pair{std:("getParticipantsForRoom"), mock()}, 
                object::pair{std:("getEntityById"), mock()}, 
                object::pair{std:("getRoom"), mock()}
            }));
    ...
    describe(std:("Messages"), [=]() mutable
    {
        ...
        auto mockMessages = array<std::shared_ptr<Memory>>{ object{
            object::pair{std:("id"), as<std::shared_ptr<UUID>>(std:("123e4567-e89b-12d3-a456-426614174008"))}, 
            ...
            object::pair{std:("createdAt"), Date->now() - 5000}, 
            object::pair{std:("content"), as<std::shared_ptr<Content>>(object{
                object::pair{std:("text"), std:("Hello everyone!")}, 
                object::pair{std:("action"), std:("wave")}
            })}, 
            object::pair{std:("agentId"), std:("123e4567-e89b-12d3-a456-426614174001")}
        }, object{
            object::pair{std:("id"), as<std::shared_ptr<UUID>>(std:("123e4567-e89b-12d3-a456-426614174010"))}, 
            object::pair{std:("roomId"), as<std::shared_ptr<UUID>>(std:("123e4567-e89b-12d3-a456-426614174009"))}, 
            object::pair{std:("entityId"), as<std::shared_ptr<UUID>>(const_(mockEntities)[1]->id)}, 
            object::pair{std:("createdAt"), Date->now() - 60000}, 
            object::pair{std:("content"), as<std::shared_ptr<Content>>(object{
                object::pair{std:("text"), std:("Hi Alice!")}, 
                object::pair{std:("attachments"), array<object>{ object{
                    object::pair{std:("id"), as<std::shared_ptr<UUID>>(std:("123e4567-e89b-12d3-a456-426614174011"))}, 
                    object::pair{std:("title"), std:("Document")}, 
