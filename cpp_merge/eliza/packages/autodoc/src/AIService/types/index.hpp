#ifndef _HOME_RUNNER_WORK_ELIZAOS-CPP_ELIZAOS-CPP_ELIZA_PACKAGES_AUTODOC_SRC_AISERVICE_TYPES_INDEX_H
#define _HOME_RUNNER_WORK_ELIZAOS-CPP_ELIZAOS-CPP_ELIZA_PACKAGES_AUTODOC_SRC_AISERVICE_TYPES_INDEX_H
#include "core.h"
#include "../../types.h"
