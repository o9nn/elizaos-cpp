...
MockRuntime createMockRuntime(Partial<MockRuntime> overrides)
{
    auto mockRuntime = object{
        ...
        object::pair{std::string("registerPlugin"), mock()->mockResolvedValue(std::nullopt)}, 
        object::pair{std::string("initialize"), mock()->mockResolvedValue(std::nullopt)}, 
        object::pair{std::string("getKnowledge"), mock()->mockResolvedValue(array<any>())}, 
        object::pair{std::string("addKnowledge"), mock()->mockResolvedValue(std::nullopt)}, 
        ...
        object::pair{std::string("processActions"), mock()->mockResolvedValue(std::nullopt)}, 
        ...
        object::pair{std::string("ensureConnection"), mock()->mockResolvedValue(std::nullopt)}, 
        object::pair{std::string("ensureParticipantInRoom"), mock()->mockResolvedValue(std::nullopt)}, 
        object::pair{std::string("ensureWorldExists"), mock()->mockResolvedValue(std::nullopt)}, 
        object::pair{std::string("ensureRoomExists"), mock()->mockResolvedValue(std::nullopt)}, 
        object::pair{std::string("db"), object{}}, 
        object::pair{std::string("init"), mock()->mockResolvedValue(std::nullopt)}, 
        object::pair{std::string("close"), mock()->mockResolvedValue(std::nullopt)}, 
        ...
        object::pair{std::string("ensureAgentExists"), mock()->mockResolvedValue(std::nullopt)}, 
        object::pair{std::string("ensureEmbeddingDimension"), mock()->mockResolvedValue(std::nullopt)}, 
        ...
        object::pair{std::string("updateEntity"), mock()->mockResolvedValue(std::nullopt)}, 
        ...
        object::pair{std::string("updateComponent"), mock()->mockResolvedValue(std::nullopt)}, 
        object::pair{std::string("deleteComponent"), mock()->mockResolvedValue(std::nullopt)}, 
        ...
        object::pair{std::string("emitEvent"), mock()->mockResolvedValue(std::nullopt)}, 
        ...
        object::pair{std::string("setParticipantUserState"), mock()->mockResolvedValue(std::nullopt)}, 
        object::pair{std::string("updateParticipantUserState"), mock()->mockResolvedValue(std::nullopt)}, 
        ...
        object::pair{std::string("endRun"), mock()->mockReturnValue(std::nullopt)}, 
