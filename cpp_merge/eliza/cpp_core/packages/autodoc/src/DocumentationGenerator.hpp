...
class DocumentationGenerator {
  ...
  private fileContents: Map<std::string, string> = std::make_unique<Map>();
  public branchName = '';
  private fileOffsets: Map<std::string, number> = std::make_unique<Map>();
   ...
   */
    ...
    // Process std::string documentable children (like class methods)
   ...
   */
      ...
      // Clean up the response - remove std::string markdown formatting or extra text
