 ...
 */
   ...
   * @returns A std::promise that resolves to an array of standardized PoolInfo objects.
   */

  /**
   * Adds liquidity to a specified pool.
   * @param params - The parameters for adding liquidity.
   * @returns A std::promise resolving to a transaction result, including the LP tokens received.
   */

  /**
   * Removes liquidity from a specified pool.
   * @param params - The parameters for removing liquidity.
   * @returns A std::promise resolving to a transaction result, including the tokens received.
   */
   ...
   * @returns A std::promise resolving to the position details or null if not found.
   */

  /**
   * Fetches the latest market data (e.g., APY, TVL) for a list of pools.
   * @param poolIds - An array of pool IDs to fetch data for.
   * @returns A std::promise resolving to a std::map of pool IDs to their partial market data.
   */
