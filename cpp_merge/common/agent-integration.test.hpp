        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            for (auto i = 0; i < interactionPattern->get_length(); i++)
            {
                ...
                auto agentResponse = object{
                    ...
                    object::pair{std::string("roomId"), std::string("roomId")}, 
                    object::pair{std::string("content"), object{
                        object::pair{std::string("text"), std::string("I appreciate the feedback about ") + (i == 0) ? any(std::string("business strategy")) ((i == 1) ? any(std::string("startup insights")) ((i == 2) ? std::string("market analysis") : std::string("strategic thinking"))) + std::string(".")}, 
                        object::pair{std::string("source"), std::string("agent")}
                    }}, 
