            ...
            global->fetch = [=](auto url, auto options) mutable
            {
                ...
                return as<std::shared_ptr<Response>>(object{
                    ...
                    object::pair{std::string("headers"), object{
                        ...
                        {
                            return ((name == std::string("content-length")) ? any(std::string("100")) (nullptr));
                        }
                        }
                    }}, 
            ...
            global->fetch = [=](auto url, auto options) mutable
            {
                ...
                return as<std::shared_ptr<Response>>(object{
                    ...
                    object::pair{std::string("headers"), object{
                        object::pair{std::string("get"), [=](auto name) mutable
                        {
                            return ((name == std::string("content-length")) ? any(std::string("0")) (nullptr));
                        }
                        }
                    }}, 
                    object::pair{std::string("json"), [=]() mutable
            ...
            global->fetch = [=](auto url, auto options) mutable
            {
                ...
                return as<std::shared_ptr<Response>>(object{
                    ...
                    object::pair{std::string("headers"), object{
                        object::pair{std::string("get"), [=](auto name) mutable
                        {
                            return ((name == std::string("content-length")) ? any(std::string("10")) (nullptr));
                        }
                        }
                    }}, 
                    object::pair{std::string("json"), [=]() mutable
