...
- Price: ") + (historicalData["price_usd"]) ? any(std::string("$") + historicalData["price_usd"]->toLocaleString(std::nullopt, object{
                object::pair{std::string("minimumFractionDigits"), 2}, 
                object::pair{std::string("maximumFractionDigits"), 6}
            }) + string_empty) (std::string("N/A")) + std::string("\
- Market Cap: ") + (historicalData["market_cap_usd"]) ? any(std::string("$") + formatMarketCap(historicalData["market_cap_usd"]) + string_empty) (std::string("N/A")) + std::string("\
- 24h Volume: ") + (historicalData["total_volume_usd"]) ? any(std::string("$") + formatMarketCap(historicalData["total_volume_usd"]) + string_empty) (std::string("N/A")) + std::string("\
