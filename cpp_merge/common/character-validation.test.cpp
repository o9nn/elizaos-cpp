#include "character-validation.test.h"
#include <string>
...
void Main(void)
{
    describe(std::string("Character Schema Validation"), [=]() mutable
    {
        ...
        describe(std::string("validateCharacter"), [=]() mutable
        {
            ...
            test(std::string("should accept bio array"), [=]() mutable
            {
        ...
        describe(std::string("isValidCharacter"), [=]() mutable
        {
            ...
            test(std::string("should return false for non-object input"), [=]() mutable
            {
                ...
                expect(isValidCharacter(std::nullopt))->toBe(false);
        ...
        {
            test(std::string("should handle null and std::nullopt inputs"), [=]() mutable
            {
                expect(validateCharacter(nullptr)->success)->toBe(false);
                expect(validateCharacter(std::nullopt)->success)->toBe(false);
            }
            );
