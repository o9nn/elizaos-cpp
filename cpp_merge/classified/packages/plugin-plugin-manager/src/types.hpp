#ifndef _HOME_RUNNER_WORK_ELIZAOS-CPP_ELIZAOS-CPP_CLASSIFIED_PACKAGES_PLUGIN-PLUGIN-MANAGER_SRC_TYPES_H
#define _HOME_RUNNER_WORK_ELIZAOS-CPP_ELIZAOS-CPP_CLASSIFIED_PACKAGES_PLUGIN-PLUGIN-MANAGER_SRC_TYPES_H
#include "core.h"
...
enum struct PluginStatus {
    BUILDING = std::string("building"), READY = std::string("ready"), LOADED = std::string("loaded"), ERROR = std::string("error"), UNLOADED = std::string("unloaded"), NEEDS_CONFIGURATION = std::string("needs_configuration")
};
