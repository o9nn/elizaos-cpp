...
std::function<any()> createTypedMockRuntime = [=]() mutable
{
    ...
    auto runtime = object{
        ...
        object::pair{std::string("ensureParticipantExists"), mock()->mockResolvedValue(std::nullopt)}, 
        object::pair{std::string("ensureUserExists"), mock()->mockResolvedValue(std::nullopt)}, 
