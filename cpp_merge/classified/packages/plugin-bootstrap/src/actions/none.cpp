...
std::shared_ptr<Action> noneAction = as<std::shared_ptr<Action>>(object{
    ...
    {
        return object{
            object::pair{std:("text"), std:("No additional action taken")}, 
            object::pair{std:("values"), object{
                object::pair{std:("success"), true}, 
                object::pair{std:("actionType"), std:("NONE")}
            }}, 
            object::pair{std:("data"), object{
                object::pair{std:("actionName"), std:("NONE")}, 
                object::pair{std:("description"), std:("Response without additional action")}
            }}, 
            object::pair{std:("success"), true}
        };
    }
