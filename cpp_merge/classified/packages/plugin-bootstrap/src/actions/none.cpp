#include "/home/runner/work/elizaos-cpp/elizaos-cpp/classified/packages/plugin-bootstrap/src/actions/none.h"
...
std::shared_ptr<Action> noneAction = as<std::shared_ptr<Action>>(object{
    ...
    {
        return object{
            object::pair{std::string("text"), std::string("No additional action taken")}, 
            object::pair{std::string("values"), object{
                object::pair{std::string("success"), true}, 
                object::pair{std::string("actionType"), std::string("NONE")}
            }}, 
            object::pair{std::string("data"), object{
                object::pair{std::string("actionName"), std::string("NONE")}, 
                object::pair{std::string("description"), std::string("Response without additional action")}
            }}, 
            object::pair{std::string("success"), true}
        };
    }
