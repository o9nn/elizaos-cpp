...
std::shared_ptr<Response> createMockResponse()
{
    auto res = object{
        ...
        object::pair{std::string("sendFile"), jest->fn([=](auto _path, auto options = std::nullopt, auto callback = std::nullopt) mutable
        {
...
any createMockHttpServer()
{
    return object{
        ...
        {
            return (object{
                object::pair{std::string("port"), 7777}
            });
        }
        )}, 
...
std::shared_ptr<Express::Multer::File> createMockUploadedFile(Partial<std::shared_ptr<Express::Multer::File>> overrides)
{
    return utils::assign(object{
        ...
        object::pair{std::string("stream"), as<any>(std::nullopt)}, 
