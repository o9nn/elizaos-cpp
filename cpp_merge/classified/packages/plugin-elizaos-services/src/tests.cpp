    ...
    object::pair{std::string("tests"), array<object>{ object{
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            catch (const any& error)
            {
                ...
                throw any(std::make_shared<Error>(std::string("Embedding generation failed: ") + (is<Error>(error)) ? any(error->message) (std::string("Unknown error")) + string_empty));
            }
        }
        }
    }, object{
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            catch (const any& error)
            {
                ...
                throw any(std::make_shared<Error>(std::string("Small text generation failed: ") + (is<Error>(error)) ? any(error->message) (std::string("Unknown error")) + string_empty));
            }
        }
        }
    }, object{
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            catch (const any& error)
            {
                ...
                throw any(std::make_shared<Error>(std::string("Large text generation failed: ") + (is<Error>(error)) ? any(error->message) (std::string("Unknown error")) + string_empty));
            }
        }
        }
    }, object{
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            catch (const any& error)
            {
                ...
                throw any(std::make_shared<Error>(std::string("Object generation failed: ") + (is<Error>(error)) ? any(error->message) (std::string("Unknown error")) + string_empty));
            }
        }
        }
    }, object{
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            catch (const any& error)
            {
                ...
                throw any(std::make_shared<Error>(std::string("Image description failed: ") + (is<Error>(error)) ? any(error->message) (std::string("Unknown error")) + string_empty));
            }
        }
        }
    }, object{
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            try
            {
                ...
                {
                    console->log(std::string("⚠️  Storage operations failed (may be due to configuration):"), (is<Error>(storageError)) ? any(storageError->message) (std::string("Unknown error")));
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            catch (const any& error)
            {
                ...
                throw any(std::make_shared<Error>(std::string("Error handling test failed: ") + (is<Error>(error)) ? any(error->message) (std::string("Unknown error")) + string_empty));
            }
        }
        }
    } }}
