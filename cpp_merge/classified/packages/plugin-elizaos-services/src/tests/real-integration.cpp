#include "real-integration.test.h"
#include <string>
    ...
    object::pair{std::string("tests"), array<object>{ object{
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            catch (const any& error)
            {
                ...
                throw any(std::make_shared<Error>(std::string("Real OpenAI API test failed: ") + (is<Error>(error)) ? any(error->message) (std::string("Unknown error")) + string_empty));
            }
        }
        }
    }, object{
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            catch (const any& error)
            {
                ...
                throw any(std::make_shared<Error>(std::string("Real OpenAI embedding test failed: ") + (is<Error>(error)) ? any(error->message) (std::string("Unknown error")) + string_empty));
            }
        }
        }
    }, object{
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            catch (const any& error)
            {
                ...
                throw any(std::make_shared<Error>(std::string("Real Groq API test failed: ") + (is<Error>(error)) ? any(error->message) (std::string("Unknown error")) + string_empty));
            }
        }
        }
    }, object{
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            catch (const any& error)
            {
                ...
                throw any(std::make_shared<Error>(std::string("Real R2 storage test failed: ") + (is<Error>(error)) ? any(error->message) (std::string("Unknown error")) + string_empty));
            }
        }
        }
    }, object{
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            catch (const any& error)
            {
                ...
                throw any(std::make_shared<Error>(std::string("Multi-provider test failed: ") + (is<Error>(error)) ? any(error->message) (std::string("Unknown error")) + string_empty));
            }
        }
        }
    }, object{
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            catch (const any& error)
            {
                ...
                throw any(std::make_shared<Error>(std::string("Service health check failed: ") + (is<Error>(error)) ? any(error->message) (std::string("Unknown error")) + string_empty));
            }
        }
        }
    } }}
