#ifndef _HOME_RUNNER_WORK_ELIZAOS_CPP_ELIZAOS_CPP_CLASSIFIED_PACKAGES_GAME_CYPRESS_SUPPORT_KNOWLEDGE_HELPERS_H
#define _HOME_RUNNER_WORK_ELIZAOS_CPP_ELIZAOS_CPP_CLASSIFIED_PACKAGES_GAME_CYPRESS_SUPPORT_KNOWLEDGE_HELPERS_H
#include "core.hpp"
#include <string>
...
namespace global {
    namespace Cypress {
        ...
        public:
            ...
            virtual std::shared_ptr<Cypress::Chainable<std::shared_ptr<KnowledgeTestHelper>>> knowledgeHelper(string agentId = std::nullopt) = 0;
            virtual std::shared_ptr<Cypress::Chainable<std::shared_ptr<UploadResponse>>> uploadKnowledgeFile(string fileName, string content, string fileType = std::nullopt) = 0;
            virtual std::shared_ptr<Cypress::Chainable<array<std::shared_ptr<KnowledgeSearchResult>>>> searchKnowledge(string query, double count = std::nullopt) = 0;
