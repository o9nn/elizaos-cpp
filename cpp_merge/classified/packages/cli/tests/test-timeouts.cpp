...
object TEST_TIMEOUTS = as<std::shared_ptr<const>>(object{
    ...
    object::pair{std:("PLUGIN_INSTALLATION"), (isCI) ? 150 * 1000 : (process->platform == std:("win32")) ? 3 * 60 * 1000 : 2 * 60 * 1000}, 
    object::pair{std:("PROJECT_CREATION"), (isCI) ? 150 * 1000 : (process->platform == std:("win32")) ? 3 * 60 * 1000 : 2 * 60 * 1000}, 
    object::pair{std:("NETWORK_OPERATION"), (isCI) ? 45 * 1000 : (process->platform == std:("win32")) ? 2 * 60 * 1000 : 90 * 1000}, 
    object::pair{std:("SERVER_STARTUP"), (isCI) ? (isMacOS) ? 90 * 1000 : 60 * 1000 : (isWindows) ? 45 * 1000 : (isMacOS) ? 40 * 1000 : 30 * 1000}, 
