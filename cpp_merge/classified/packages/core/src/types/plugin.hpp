#ifndef _HOME_RUNNER_WORK_ELIZAOS-CPP_ELIZAOS-CPP_CLASSIFIED_PACKAGES_CORE_SRC_TYPES_PLUGIN_H
#define _HOME_RUNNER_WORK_ELIZAOS-CPP_ELIZAOS-CPP_CLASSIFIED_PACKAGES_CORE_SRC_TYPES_PLUGIN_H
#include "core.h"
#include "./agent.h"
...
public:
    ...
    std::function<std::shared_ptr<Promise<boolean>>(std::shared_ptr<IAgentRuntime>)> isValid;
