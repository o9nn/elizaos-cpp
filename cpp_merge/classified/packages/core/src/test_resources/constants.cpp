...
string TEST_EMAIL = std::string("testuser123@example.com");
string TEST_PASSWORD = std::string("mock_password_123!@#");
string TEST_EMAIL_2 = std::string("testuser234@example.com");
string TEST_PASSWORD_2 = std::string("mock_password_234!@#");
