#include "/home/runner/work/elizaos-cpp/elizaos-cpp/classified/packages/server/src/api/runtime/logging.h"
    ...
    auto logsHandler = [=](auto req, auto res) mutable
    {
        ...
        try
        {
            ...
            logger->debug(std:("Logs request processed"), object{
                ...
                object::pair{std:("agentNamePopulationRate"), Math->round(agentNamePopulationRate * 100) + std:("%")}, 
                object::pair{std:("agentIdPopulationRate"), Math->round(agentIdPopulationRate * 100) + std:("%")}, 
            ...
            res->json(object{
                ...
                object::pair{std:("requestedLevel"), requestedLevel}, 
