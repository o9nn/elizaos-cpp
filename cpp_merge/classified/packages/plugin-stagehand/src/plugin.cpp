...
std::shared_ptr<Action> browserNavigateAction = object{
    ...
    object::pair{std::string("validate"), [=](auto runtime, auto message, auto _state = std::nullopt) mutable
    {
    ...
    object::pair{std::string("handler"), [=](auto runtime, auto message, auto _state = std::nullopt, auto _options = std::nullopt, auto callback = std::nullopt, auto _responses = std::nullopt) mutable
    {
        try
        {
        ...
        catch (const any& error)
        {
            ...
            return object{
                ...
                object::pair{std::string("data"), object{
                    object::pair{std::string("actionName"), std::string("BROWSER_NAVIGATE")}, 
                    object::pair{std::string("error"), (is<Error>(error)) ? any(error->message) (std::string("unknown_error"))}, 
...
std::shared_ptr<Action> browserClickAction = object{
    ...
    object::pair{std::string("handler"), [=](auto runtime, auto message, auto _state = std::nullopt, auto _options = std::nullopt, auto callback = std::nullopt) mutable
    {
        try
        {
            ...
            auto description = (match) ? any(const_(match)[1]) (std::string("element"));
...
std::shared_ptr<Action> browserTypeAction = object{
    ...
    object::pair{std::string("handler"), [=](auto runtime, auto message, auto _state = std::nullopt, auto _options = std::nullopt, auto callback = std::nullopt) mutable
    {
        try
        {
            ...
            auto field = (fieldMatch) ? any(const_(fieldMatch)[1]) (std::string("input field"));
            if (!textToType) {
...
std::shared_ptr<Action> browserSelectAction = object{
    ...
    object::pair{std::string("handler"), [=](auto runtime, auto message, auto _state = std::nullopt, auto _options = std::nullopt, auto callback = std::nullopt) mutable
    {
        try
        {
            ...
            auto dropdown = (dropdownMatch) ? any(const_(dropdownMatch)[1]) (std::string("dropdown"));
            if (!option) {
