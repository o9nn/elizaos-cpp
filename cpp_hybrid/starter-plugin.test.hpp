#ifndef _HOME_RUNNER_WORK_ELIZAOS-CPP_ELIZAOS-CPP_ELIZA_PACKAGES_PROJECT-STARTER_SRC___TESTS___E2E_STARTER-PLUGIN_TEST_H
#define _HOME_RUNNER_WORK_ELIZAOS-CPP_ELIZAOS-CPP_ELIZA_PACKAGES_PROJECT-STARTER_SRC___TESTS___E2E_STARTER-PLUGIN_TEST_H
#include "core.h"
#include "uuid.h"
using uuidv4 = v4;
...
public:
    ...
    array<object> tests = array<object>{ object{
        ...
        object::pair{std::string("name"), std::string("Hello world action test - Direct execution")}, 
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            auto message = object{
                object::pair{std::string("entityId"), as<UUID>(uuidv4())}, 
                object::pair{std::string("roomId"), as<UUID>(uuidv4())}, 
        ...
        object::pair{std::string("name"), std::string("Natural language hello world test")}, 
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            try
            {
                auto userMessage = object{
                    ...
                    object::pair{std::string("content"), object{
                        object::pair{std::string("text"), std::string("Please say hello world")}, 
                        object::pair{std::string("source"), std::string("test")}
                    }}
                };
                ...
                if (!agentResponse) {
                    auto state = object{
                        object::pair{std::string("values"), object{}}, 
                        object::pair{std::string("data"), object{}}, 
                        object::pair{std::string("text"), userMessage->content["text"]}
                    };
