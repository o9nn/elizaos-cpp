#ifndef _HOME_RUNNER_WORK_ELIZAOS-CPP_ELIZAOS-CPP_SPARTAN_SRC_PLUGINS_AUTOFUNTRADER_SERVICES_CALCULATION_BIRDEYE_H
#define _HOME_RUNNER_WORK_ELIZAOS-CPP_ELIZAOS-CPP_SPARTAN_SRC_PLUGINS_AUTOFUNTRADER_SERVICES_CALCULATION_BIRDEYE_H
#include "core.h"
