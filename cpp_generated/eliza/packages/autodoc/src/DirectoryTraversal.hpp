#ifndef _HOME_RUNNER_WORK_ELIZAOS-CPP_ELIZAOS-CPP_ELIZA_PACKAGES_AUTODOC_SRC_DIRECTORYTRAVERSAL_H
#define _HOME_RUNNER_WORK_ELIZAOS-CPP_ELIZAOS-CPP_ELIZA_PACKAGES_AUTODOC_SRC_DIRECTORYTRAVERSAL_H
#include "core.h"
#include "node:fs.h"
using fs = _default;
#include "node:path.h"
