#include "/home/runner/work/elizaos-cpp/elizaos-cpp/classified/packages/agentserver/src/api/runtime/health.h"
    ...
    router->get(std::string("/health"), [=](auto _req, auto res) mutable
    {
        ...
        auto healthcheck = object{
            ...
            object::pair{std::string("dependencies"), object{
                object::pair{std::string("agents"), (agents->size > 0) ? std::string("healthy") : std::string("ready")}
            }}
        };
