#include "/home/runner/work/elizaos-cpp/elizaos-cpp/classified/packages/plugin-sql/src/pg/adapter.h"
...
std::shared_ptr<Promise<array<std::shared_ptr<Entity>>>> PgDatabaseAdapter::getEntitiesByIds(array<std::shared_ptr<UUID>> entityIds)
{
    return __super::getEntitiesByIds(entityIds)->then([=](auto result) mutable
    {
