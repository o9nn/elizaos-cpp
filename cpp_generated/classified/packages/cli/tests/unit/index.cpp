...
void Main(void)
{
    ...
    describe(std::string("Signal handling"), [=]() mutable
    {
        ...
        auto testGracefulShutdown = [=](auto signal, auto expectedExitCode) mutable
        {
            ...
            auto exitCode = (signal == std::string("SIGINT")) ? any(130) : any((signal == std::string("SIGTERM")) ? 143 : 0);
        ...
        it(std::string("should handle fallback exit code for unknown signals"), [=]() mutable
        {
            ...
            auto exitCode = (unknownSignal == std::string("SIGINT")) ? any(130) : any((unknownSignal == std::string("SIGTERM")) ? 143 : 0);
