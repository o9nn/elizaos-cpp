#include "/home/runner/work/elizaos-cpp/elizaos-cpp/classified/packages/plugin-sam/src/__tests__/integration.test.h"
    ...
    describe(std::string("Integration: SAY_ALOUD Action with SamTTSService"), [=]() mutable
    {
        ...
        beforeEach([=]() mutable
        {
            ...
            shared mockSamService = object{
                object::pair{std::string("generateAudio"), [=](auto text, auto _options = undefined) mutable
                {
                    auto audioLength = text->get_length() * 100;
                    return ((std::make_shared<Uint8Array>(audioLength)))->fill(42);
                }
                }, 
                object::pair{std::string("speakText"), [=](auto text, auto options = undefined) mutable
                {
