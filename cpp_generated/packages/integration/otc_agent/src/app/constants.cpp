#include "/home/runner/work/elizaos-cpp/elizaos-cpp/otc-agent/src/app/constants.h"

object siteConfig = object{
    object::pair{std::string("name"), std::string("AI Eliza")}, 
    object::pair{std::string("url"), OR((OR((process->env->NEXT_PUBLIC_APP_URL), (std::string("https://ai.eliza.how/")))), (std::string("http://localhost:5005")))}, 
