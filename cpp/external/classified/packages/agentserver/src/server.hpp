...
class AgentServer {
  ...
  private logStreamConnections: Map<std::string, { agentName?: std::string; level?: std::string }> = new Map();
   ...
   */
      ...
      // Handle initial connection message
            ...
            // Decode base64 data if provided as std::string
    ...
    std::optional<(data: std::any) => Promise<void>> processMediaStream;
};
   ...
   */
      ...
      // Convert channelId std::string to UUID
