...
std::string getKnowledgePath() {
    ...
    if (envPath) {
        ...
        if (!fs.existsSync(resolvedPath)) {
            std::cout << "Knowledge path from environment variable does not exist: " + resolvedPath << std::endl;
    ...
    if (!fs.existsSync(defaultPath)) {
        std::cout << "Default docs folder does not exist at: " + defaultPath << std::endl;
    ...
    try {
        ...
        for (const auto& entry : entries)
            ...
            if (entry.isDirectory()) {
                ...
                std::cerr << "Error reading directory " + dirPath + ":" << error << std::endl;
            }
