...
public:
    ...
    std::string name = std::string("forms-plugin-e2e");

    std::string description = std::string("E2E tests for the forms plugin");
    ...
    array<object> tests = array<object>{ object{
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            if (!formsService) {
                throw std::any(std::make_shared<Error>(std::string("Forms service not found")));
            }
            ...
            if (activeForms->get_length() == 0) {
                throw std::any(std::make_shared<Error>(std::string("Form was created but not found in list")));
            }
        }
        }
    }, object{
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            console->log(std::string("Runtime actions:"), OR((runtime->actions->std::map([=](auto a) mutable
            {
                return a["name"];
            }
            )), (array<any>())));
            console->log(std::string("Runtime providers:"), OR((runtime->providers->std::map([=](auto p) mutable
            {
                return p["name"];
            }
            )), (array<any>())));
            ...
            if (!formsService) {
                throw std::any(std::make_shared<Error>(std::string("Forms service not registered")));
            }
            ...
            if (!createFormAction) {
                throw std::any(std::make_shared<Error>(std::string("CREATE_FORM action not found")));
            }
            if (!updateFormAction) {
                throw std::any(std::make_shared<Error>(std::string("UPDATE_FORM action not found")));
            }
            if (!cancelFormAction) {
                throw std::any(std::make_shared<Error>(std::string("CANCEL_FORM action not found")));
            }
            ...
            if (!formsProvider) {
                throw std::any(std::make_shared<Error>(std::string("Forms provider not found")));
            }
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            console->log(std::string("Active forms:"), activeForms->get_length());
            if (activeForms->get_length() == 0) {
                throw std::any(std::make_shared<Error>(std::string("No active forms found after creation")));
            }
            auto createFormAction = runtime->actions->find([=](auto a) mutable
            {
                return a["name"] == std::string("CREATE_FORM");
            ...
            if (!form) {
                throw std::any(std::make_shared<Error>(std::string("Created form not found")));
            }
            ...
            if (completedForms->get_length() == 0) {
                throw std::any(std::make_shared<Error>(std::string("Form was not marked as completed")));
            }
            ...
            if (nameField->value != std::string("John Doe")) {
                throw std::any(std::make_shared<Error>(std::string("Name field not updated correctly")));
            }
            if (emailField->value != std::string("john@example.com")) {
                throw std::any(std::make_shared<Error>(std::string("Email field not updated correctly")));
            }
            if (AND((AND((messageField), (messageField->value))), (type_of(messageField->value) == std::string("string")))) {
                if (!messageField->value->includes(std::string("services"))) {
                    throw std::any(std::make_shared<Error>(std::string("Message field not updated correctly")));
                }
            }
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            if (OR((!createFormAction), (!cancelFormAction))) {
                throw std::any(std::make_shared<Error>(std::string("Required actions not found")));
            }
            ...
            if (!createdFormId) {
                throw std::any(std::make_shared<Error>(std::string("Form was not created")));
            }
            console->log(std::string("Created form to cancel:"), createdFormId);
            auto formsService = as<std::shared_ptr<FormsService>>(runtime->getService(std::string("forms")));
            auto activeForms = std::async([=]() { formsService->listForms(std::string("active")); });
            if (activeForms->get_length() == 0) {
                throw std::any(std::make_shared<Error>(std::string("No active forms found")));
            }
            ...
            if (cancelledForms->get_length() == 0) {
                throw std::any(std::make_shared<Error>(std::string("Form was not cancelled")));
            }
            ...
            if (targetFormStillActive) {
                throw std::any(std::make_shared<Error>(std::string("Form still active after cancellation")));
            }
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            if (!providerResult->text->includes(std::string("Active Form:"))) {
                ...
                throw std::any(std::make_shared<Error>(std::string("Provider did not return active forms information")));
            }
            if (OR((!providerResult->data->forms), (providerResult->data->forms->length == 0))) {
                throw std::any(std::make_shared<Error>(std::string("Provider did not return active forms data")));
            }
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            auto allForms = std::async([=]() { formsService->listForms(); });
            console->log(std::string("All forms after creation:"), allForms->std::map([=](auto f) mutable
            {
                return (object{
                    object::pair{std::string("id"), f->id}, 
                    object::pair{std::string("name"), f->name}, 
            ...
            console->log(std::string("API form status:"), apiForm->status, std::string("fields:"), const_(apiForm->steps)[0]->fields->std::map([=](auto f) mutable
            {
                return (object{
                    object::pair{std::string("id"), f->id}, 
            ...
            if (!updateResult->success) {
                throw std::any(std::make_shared<Error>(std::string("Failed to update form with secret")));
            }
            ...
            console->log(std::string("Updated form fields:"), const_(updatedForm->steps)[0]->fields->std::map([=](auto f) mutable
            {
                return (object{
                    object::pair{std::string("id"), f->id}, 
                    object::pair{std::string("value"), f->value}, 
            ...
            auto completedForms = std::async([=]() { formsService->listForms(std::string("completed")); });
            console->log(std::string("Completed forms:"), completedForms->std::map([=](auto f) mutable
            {
                return (object{
                    object::pair{std::string("id"), f->id}, 
                    object::pair{std::string("name"), f->name}
            ...
            if (!completedApiForm) {
                throw std::any(std::make_shared<Error>(std::string("api-setup form not found in completed forms")));
            }
            ...
            if (OR((!secretField), (!secretField->value))) {
                throw std::any(std::make_shared<Error>(std::string("Secret field was not set")));
            }
            if (!secretField->secret) {
                throw std::any(std::make_shared<Error>(std::string("API key field is not marked as secret")));
            }
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            if (!step1Completed) {
                throw std::any(std::make_shared<Error>(std::string("Step 1 callback was not executed")));
            }
            ...
            if (OR((!formAfterStep1), (formAfterStep1->currentStepIndex != 1))) {
                throw std::any(std::make_shared<Error>(std::string("Form did not progress to step 2")));
            }
            std::async([=]() { formsService->updateForm(multiStepForm->id, as<std::shared_ptr<Memory>>(object{
                object::pair{std::string("entityId"), asUUID(uuidv4())}, 
                object::pair{std::string("agentId"), runtime->agentId}, 
            ...
            if (!step2Completed) {
                throw std::any(std::make_shared<Error>(std::string("Step 2 callback was not executed")));
            }
            if (!formCompleted) {
                throw std::any(std::make_shared<Error>(std::string("Form completion callback was not executed")));
            }
