...
public:
    ...
    std::string name = std::string("project-manager");

    std::string description = std::string("Tests for the project manager agent");
    ...
    array<object> tests = array<object>{ object{
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            if (!completed) throw std::any(std::make_shared<Error>(std::string("Project creation timed out")));
        }
        }
    }, object{
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            auto completed = std::async([=]() { this->scenarioService["waitForCompletion"](this->completionTimeout); });
            if (!completed) throw std::any(std::make_shared<Error>(std::string("Task assignment timed out")));
        }
        }
    }, object{
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            auto completed = std::async([=]() { this->scenarioService["waitForCompletion"](this->completionTimeout); });
            if (!completed) throw std::any(std::make_shared<Error>(std::string("Status report generation timed out")));
        }
        }
    }, object{
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            auto completed = std::async([=]() { this->scenarioService["waitForCompletion"](this->completionTimeout); });
            if (!completed) throw std::any(std::make_shared<Error>(std::string("Meeting scheduling timed out")));
        }
        }
    }, object{
        ...
        object::pair{std::string("fn"), [=](auto runtime) mutable
        {
            ...
            auto completed = std::async([=]() { this->scenarioService["waitForCompletion"](this->completionTimeout); });
            if (!completed) throw std::any(std::make_shared<Error>(std::string("Off-topic handling timed out")));
        }
        }
    } };
};
