...
public:
    ...
    virtual std::shared_ptr<Promise<std::shared_ptr<EngineeredFeatures>>> engineerFeatures(array<Record<std::string, any>> data, std::shared_ptr<FeatureConfig> config);
    virtual std::any processNumericalFeatures(array<Record<std::string, any>> data, std::shared_ptr<NumericalFeatureConfig> config);
    virtual std::any processCategoricalFeatures(array<Record<std::string, any>> data, std::shared_ptr<CategoricalFeatureConfig> config);
};
