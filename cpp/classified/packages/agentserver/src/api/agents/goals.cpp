                        ...
                        try {
                            ...
                            const auto goalId = (goalsService).createGoal({;
                                ...
                                const Goal goal = {;
                                    ...
                                    std::cout << "[GOALS CREATE] Created goal \"" + name + "\" for agent " + runtime.character.name << std::endl;
                                            ...
                                            const auto success = (goalsService).updateGoal(goalId, {;
                                                ...
                                                if (status == 'completed' && !existingGoal.isCompleted) {
                                                    ...
                                                    const Goal goal = {;
                                                        ...
                                                        std::cout << "[GOALS UPDATE] Updated goal " + goalId + " for agent " + runtime.character.name << std::endl;
                                                        ...
                                                        router.delete("/:agentId/goals/:goalId", async (req, res) => {
                                                            ...
                                                            try {
                                                                ...
                                                                std::cout << "[GOALS DELETE] Deleted goal " + goalId + " for agent " + runtime.character.name << std::endl;
