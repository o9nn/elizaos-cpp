...
public:
    ...
    std::string baseUrl = std::string("http://localhost:7777/knowledge");

    std::string agentId;

    KnowledgeTestHelper(std::string agentId = std::string("00000000-0000-0000-0000-000000000001"));
    virtual std::shared_ptr<Cypress::Chainable<std::shared_ptr<UploadResponse>>> uploadFile(std::string fileName, std::string content, std::string fileType = std::string("text/plain"));
    virtual std::shared_ptr<Cypress::Chainable<std::shared_ptr<UploadResponse>>> uploadFromUrl(std::string url);
    virtual std::shared_ptr<Cypress::Chainable<array<std::shared_ptr<KnowledgeDocument>>>> getDocuments();
    virtual std::shared_ptr<Cypress::Chainable<array<std::shared_ptr<KnowledgeChunk>>>> getDocumentChunks(std::string documentId);
    virtual std::shared_ptr<Cypress::Chainable<array<std::shared_ptr<KnowledgeSearchResult>>>> search(std::string query, double count = 10);
    virtual std::shared_ptr<Cypress::Chainable<void>> deleteDocument(std::string documentId);
    virtual std::shared_ptr<Cypress::Chainable<void>> waitForDocumentProcessing(std::string documentId, double maxWaitTime = 30000);
    virtual std::shared_ptr<Cypress::Chainable<boolean>> verifyDocumentExists(std::string documentId);
    ...
    virtual void validateApiResponse(std::any response, boolean expectedSuccessStatus = true);
...
namespace global {
    namespace Cypress {
        ...
        public:
            ...
            virtual std::shared_ptr<Cypress::Chainable<std::shared_ptr<KnowledgeTestHelper>>> knowledgeHelper(std::string agentId = undefined) = 0;
            virtual std::shared_ptr<Cypress::Chainable<std::shared_ptr<UploadResponse>>> uploadKnowledgeFile(std::string fileName, std::string content, std::string fileType = undefined) = 0;
            virtual std::shared_ptr<Cypress::Chainable<array<std::shared_ptr<KnowledgeSearchResult>>>> searchKnowledge(std::string query, double count = undefined) = 0;
            virtual std::shared_ptr<Cypress::Chainable<void>> deleteKnowledgeDocument(std::string documentId) = 0;
