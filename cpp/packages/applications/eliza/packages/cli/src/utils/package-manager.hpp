 ...
 * @returns A std::promise resolving to an object indicating whether installation succeeded and the installed package identifier, or null if all methods failed.
 */
 ...
 * @returns A std::promise resolving to an object indicating success and installed identifier
 */
