                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                            if (!agentId || !validateUuid(agentId)) {
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                try {
                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                    if (!runtime) {
                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                        std::cout << "[TITLE GENERATION] Generating title from user message: \"" + userMessage + "\"" << std::endl;
                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                if (!agentId || !validateUuid(agentId)) {
                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                    try {
                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                        if (!runtime) {
                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                            std::cout << "[PROMPT GENERATION] Generating " + count + " quick start prompts for channel " + channelId << std::endl;
                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                        try {
                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                            if (prompts.length == 0) {
                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                return res.status(200).json({;
                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                    std::cout << "[PROMPT GENERATION] Generated " + prompts.size() + " prompts for channel " + channelId << std::endl;
