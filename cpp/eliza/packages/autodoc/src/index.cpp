                ...
                !Number.isNaN(configuration.repository.pullNumber);
                    ...
                    try {
                        ...
                        try {
                            ...
                            const auto { todoItems, envUsages } = documentationGenerator.analyzeCodebase();

                            // Generate JSDoc documentation first
                            const auto { documentedItems, branchName } = documentationGenerator.generate(;
                            ...
                            if (configuration.generateReadme) {
                                ...
                                pluginDocGenerator.generate(documentedItems, targetBranch, todoItems, envUsages);
